                        ...
                        <div role="navigation" class="row container-fluid">
                            ...
                            <div role="navigation" class="row collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li role="presentation"><a targetDiv="Importantdates">Calender</a></li>
                                    
                                    <li role="presentation"><a targetDiv="BiCent"><u style="color: #922B21;">Bi-Centenary</u></a></li>

                                    <li role="presentation"><a targetDiv="conduct">Guidelines</a></li>

                                    <li role="presentation"><a targetDiv="SantSatGuru">Sant Sat Guru</a></li>
                                    ...
                                    <li role="presentation" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" data-target="#media" role="button" aria-haspopup="true" aria-expanded="false">Books | A-V | Photos&nbsp;&nbsp;<span class="caret"></span></a>
                                        <ul id="#media" class="dropdown-menu">
                                            <li><a targetDiv="Books">Books</a></li>

                                            <li><a targetDiv="Prose">Prose</a></li>

                                            <li><a targetDiv="Shabd">Poetry - RS Faith </a></li>

                                            <li><atargetDiv="SantBani">Sant Bani</a></li>

                                            <li><a targetDiv="Videoclips">Video Clips</a></li>

                                            <li><a targetDiv="Videopoetry">Video Poetry</a></li>
                                        </ul>
                                    </li>
                                    <li role="presentation"><a targetDiv="HolyPlaces">Holy Places</a></li>
                                    <li role="presentation"><a targetDiv="GenInfo">General Information</a></li>
                                    <li role="presentation"><a targetDiv="BookOrdering">Book Ordering</a></li>
                                    <li role="presentation"><a targetDiv="ContactUs">Contact Us</a></li>
                                </ul>
                            </div><!-- /.navbar-collapse -->
                        </div><!-- /.container-fluid -->
                    </nav>
                ...
                <%--<div id="LinksRow" class="row LinksDiv" style="position: fixed">
                    <!--- Insert code for Hindi and other languages -->
                        ...
                        <div style="width:98%">
                                    ...
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">OCCASIONS & SATSANG TIMINGS</h3>
                                                        ...
                                                        <div class="row"  style="margin-bottom: 10px; ">
                                                            <div class="col-md-8" style="text-align: justify;">
                                                                ...
                                                                <table style="width: 100%; text-align: center;">
                                                                    <tr>
                                                                        <th style="width: 250px; background-color: #922B21; text-align: center;">DATE</th>
                                                                        <th style="width: 200px; background-color: #922B21; text-align: center;">EARLY MORNING</th>
                                                                        <th style="width: 200px; background-color: #922B21; text-align: center;">MORNING</th>
                                                                        <th style="width: 200px; background-color: #922B21; text-align: center;">EVENING</th>
                                                                        <th style="width: 200px; background-color: #922B21; text-align: center;">NIGHT</th>
                                                                    </tr>
                                                                    <tr>
                            ...
                            <div id="conduct" class="row" divType="pageContent">
                                <div class="col-md-2  "></div>
                                <div class="col-md-10 " style="height: auto;">
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">GUIDELINES</h3>
                            ...
                            <div id="SantSatGuru" class="row" divType="pageContent">
                                <div class="col-md-offset-2 col-md-10" style="height: auto;">
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">SANT SAT GURU</h3>
                            ...
                            <div id="Images" class="row " divType="pageContent">
                                ...
                                <div class="col-md-10 " style="height: auto;">
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">PHOTOGRAPHS</h3>
                            ...
                            <div id="Books" class="row " divType="pageContent">
                                ...
                                <div class="col-md-10 " style="height: auto;">
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">BOOKS</h3>
                            ...
                            <div id="Audio" class="row " divType="pageContent">
                                ...
                                <div class="col-md-10 " style="height: auto;">
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">AUDIO</h3>
                            ...
                            <div id="Videos" class="row " divType="pageContent">
                                ...
                                <div class="col-md-10 " style="height: auto;">
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">VIDEO LIBRARY</h3>
                            ...
                            <div id="HolyPlaces" class="row" divType="pageContent">
                                ...
                                <div class="col-md-10 " style="height: auto;">
                                    <div class="row">
                                        <div class="row" style="text-align: justify;">
                                            <div class="col-md-12  " style="text-align: justify;">
                                                <h3 style=" color: #337ab7">HOLY PLACES</h3>
                                    ...
                                    <div class="row" style="text-align: justify;">
                                        ...
                                        <div class="col-md-10 " id="varnasi" style="text-align: justify;outline:none" tabindex="1">
                                            <h4 style=" color: #337ab7 ">SOAMI BAGH, VARANASI (BENARAS)
                                                <span>
